    ...
    public function add_settings( $settings, $current_section ) {
        ...
        $plugin_settings = \array_merge( $plugin_settings, array(
            array(
                ...
                . '<p>'
                . Util::barn2_link( 'kb-categories/woocommerce-product-table-kb', __( 'View Documentation', 'woocommerce-product-table' ) ) . ' | '
                . Util::barn2_link( 'our-wordpress-plugins/support-documentation', __( 'Get Help', 'woocommerce-product-table' ) )
                . '</p>'
            ),
