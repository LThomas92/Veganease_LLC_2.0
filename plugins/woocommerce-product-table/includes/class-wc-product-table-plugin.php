 ...
 */
final class WC_Product_Table_Plugin extends Premium_Plugin implements Licensed_Plugin, Registerable, Translatable, Service_Provider {
    ...
    public function load_services() {
        ...
        if ( $this->get_license()->is_valid() && Util::is_front_end() ) {
            $this->services['shortcode']        = new WC_Product_Table_Shortcode();
            $this->services['scripts']          = new WC_Product_Table_Frontend_Scripts( $this->get_version() );
    ...
    public static function instance() {
        ...
        //_deprecated_function( __FUNCTION__, '2.6', 'Barn2\\Plugin\\WC_Product_Table\\wc_product_table()' );
        return \Barn2\Plugin\WC_Product_Table\wc_product_table();
    }
