...
class Plugin_License implements Registerable, License {
    ...
    public function register() {
        ...
        add_action( 'plugins_loaded', array( $this, 'check_active_url_is_valid' ) );
    }
    ...
    public function check_active_url_is_valid() {
        if ( $this->is_active() && $this->has_site_moved() ) {
            $this->set_site_moved();
        }
    }
    ...
    public function has_site_moved() {
        ...
        return $active_url !== $this->get_home_url();
    }
    ...
    private function set_site_moved() {
